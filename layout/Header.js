      ...
      <Accordion>
        ...
        >
          <ul className="navigation clearfix">
            ...
            <li>
              <Link href="tourist-spots">Tourist Spots</Link>
            ...
            <li>
              <Link href="dining">Dining Options</Link>

            </li>
            <li>
              <Link href="medical-emergency">Medical Emergency</Link>

            </li>
            <li>
              <Link href="law-and-regulations">Regulations</Link>
      ...
      <section className="hidden-bar">
        <div className="inner-box">
          ...
          <ul className="sidebar-menu">
            ...
            <li>
              <Link href="about">Tourist Spots</Link>
              <Link href="about">Transport</Link>
              <Link href="about">Dining Options</Link>
              <Link href="about">Medical Emergency</Link>
            </li>
        ...
        <div className="header-upper bg-white py-30 rpy-0">
          <div className="container-fluid clearfix">
            <div className="header-inner rel d-flex align-items-center">
              ...
              <div className="nav-outer mx-lg-auto ps-xxl-5 clearfix" style={{ marginRight: "0px !important" }}>
                {/* Main Menu */}
                <Menu />
                {/* Main Menu End*/}
              </div>
